var itemSize = 22,
  ...
  d3.csv('frdata.csv', function ( response ) {
    ...
    var colorScale = d3.scale.threshold()
        .domain([-40, -25,-23,-22, -21,-20, -19,-18, -17, -15, 0])
        //.range(["#2980B9", "#27AE60", "#fd4000"]); //Blue (Freeze Excursion), Green (Within Range), Red (Heat Excursion)
